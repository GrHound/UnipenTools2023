...
#define NORM_EXPAND           5
#define NORM_MID_X_BASELINE_Y 6

#ifdef _ALLO_RESAMPLE_INIT_
char *scalenames[] = { ""
                     , "normalized"
                     , "leftxy"
                     , "rawxy"
...
extern void normalize_midx_basy (double *v, int m, Yfont *yfont, int *within);

extern void adjust_resampling (int ni, float *xi, float *yi, float *zi
